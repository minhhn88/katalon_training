...
/**
 * {@link #CheckoutShop checkoutSHop} <br>
 * @author nminh
 *
 */
public class Checkout {
	/**
	 * Description: .... <br> go gog
	...
	def static void CheckoutShop(String firstName,String lastName,String companyName,String country,String address,String city,String postCode,String Phone){
		...
		WebUI.waitForElementVisible(findTestObject('Pages/Checkout page/txtFirstname'), GlobalVariable.gWaitPresentTimeout)
		...
		WebUI.waitForElementVisible(findTestObject('Pages/Checkout page/inputCompanyName'), GlobalVariable.gWaitPresentTimeout)
