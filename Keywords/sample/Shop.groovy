...
public class Shop {
	...
	def static void addToCart(String productName,String urlProduct){
		...
		WebUI.waitForElementPresent(findTestObject('Pages/Shop page/btnAddToCart'), GlobalVariable.gWaitPresentTimeout)
		WebUI.click(findTestObject('Pages/Shop page/btnAddToCart'))

		WebUI.waitForElementPresent(findTestObject('Pages/Shop page/lnkViewCart'), GlobalVariable.gWaitPresentTimeout)
		WebUI.click(findTestObject('Pages/Shop page/lnkViewCart'))

		WebUI.verifyElementPresent(findTestObject('Pages/Shop page/btnProceed'), GlobalVariable.gWaitPresentTimeout)
	}
